...
$string['pluginname'] = 'Logstore file write';
$string['pluginname_desc'] = 'A log plugin stores log entries in a log file .';
$string['eventfilewritelogs'] = 'Event file write logs';
